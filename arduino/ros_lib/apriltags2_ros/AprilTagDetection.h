#ifndef _ROS_apriltags2_ros_AprilTagDetection_h
#define _ROS_apriltags2_ros_AprilTagDetection_h
...
namespace apriltags2_ros
{
  ...
  class AprilTagDetection : public ros::Msg
  {
    ...
    const char * getType(){ return "apriltags2_ros/AprilTagDetection"; };
